...
tbl_names_popular |> 
  ...
  labs(
    ...
    subtitle = 'Emma and Noah were the most popular names of the decade',
    caption = 'Source: SSA',
    x = '# Births',
    y = 'Name'
  ) +
...
tbl_names_by_letter |> 
  ...
  labs(
      title = glue::glue("Distribution of births by first letter in 2020"),
...
tbl_names_by_first_and_last_letter |> 
  ...
  labs(
      title = glue::glue("Trends in Names"),
      subtitle = "By First and Last Letter",
      caption = "Source: SSA",
      x = "First Letter",
      y = 'Last Letter'
    ) +
